...
@Component({
  selector: 'InsurancePolicy-home',
  templateUrl: './InsurancePolicy-home.component.html',
  styleUrls: ['./InsurancePolicy-home.component.scss']
})
export class InsurancePolicyHomeComponent implements AfterViewInit {
