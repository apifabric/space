...
@Component({
  selector: 'Spaceship-home',
  templateUrl: './Spaceship-home.component.html',
  styleUrls: ['./Spaceship-home.component.scss']
})
export class SpaceshipHomeComponent implements AfterViewInit {
