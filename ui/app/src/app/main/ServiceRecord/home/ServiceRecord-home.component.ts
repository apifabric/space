...
@Component({
  selector: 'ServiceRecord-home',
  templateUrl: './ServiceRecord-home.component.html',
  styleUrls: ['./ServiceRecord-home.component.scss']
})
export class ServiceRecordHomeComponent implements AfterViewInit {
