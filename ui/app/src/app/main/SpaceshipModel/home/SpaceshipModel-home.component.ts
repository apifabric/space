...
@Component({
  selector: 'SpaceshipModel-home',
  templateUrl: './SpaceshipModel-home.component.html',
  styleUrls: ['./SpaceshipModel-home.component.scss']
})
export class SpaceshipModelHomeComponent implements AfterViewInit {
