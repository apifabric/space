...
@Component({
  selector: 'ServiceAgreement-home',
  templateUrl: './ServiceAgreement-home.component.html',
  styleUrls: ['./ServiceAgreement-home.component.scss']
})
export class ServiceAgreementHomeComponent implements AfterViewInit {
